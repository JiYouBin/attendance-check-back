...
CREATE TABLE `t_lecture` (
  `lecture_idx` int(11) NOT NULL AUTO_INCREMENT COMMENT '강좌번호',
  `lecture_name` varchar(300) NOT NULL COMMENT '강의명',
...
INSERT INTO `t_lecture` VALUES (1,'웹개발자과정'),(2,'전산세무과정'),(3,'컴퓨터활용능력과정');
